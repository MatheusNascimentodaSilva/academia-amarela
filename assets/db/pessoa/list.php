...
//include_once("../conn.php");//
    ...
    if ($result-> num_rows > 0) 
    {
        ...
        while ($linha = $result->fetch_assoc()) 
        {
            ...
            echo "<td> <a href='assets/db/pessoa/select.php?email=" . $linha["email"] . "'>Detalhes</a> </td>";
            echo "<td> <a href='assets/db/pessoa/delete.php?id=" . $linha["idPessoa"] . "' onClick='return confimar()' >Excluir</a> </td>";
            echo "</tr>";
        }
